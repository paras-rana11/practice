...
HOST = '192.168.1.35'  # or your specific IP address
PORT = 5150  # or your specific port
CONNECTION_FLAG = True
conn = None
output_folder = 'C:\\ASTM\\root\\report_file\\'
log_file = 'C:\\ASTM\\root\\log_file\\port_status_for_maglumi_800.log'
error_log_file = 'C:\\ASTM\\root\\log_file\\port_status_for_maglumi_800_error.log'
...
def setup_loggers():
  ...
  try:
    ...
    send_mail_or_logging(error_message, e, 'Maglumi_800')
...
def get_filename():
  try:
    ...
    return output_folder + "maglumi_800_" + dt.strftime("%Y-%m-%d-%H-%M-%S-%f")
  except Exception as e:
