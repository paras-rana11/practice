...
# stored_license_key = "32bfee534fc1e32d0ccd83527b573361c4cdde859aa0562c7e4fb4fe458da676"
...
def get_filename(extension="txt"):
    ...
    return output_folder + "e_411_" + dt.strftime("%Y-%m-%d-%H-%M-%S-%f") + f".{extension}"


def get_port():
    try:
        port = serial.Serial(port=input_tty, baudrate=9600, timeout=5,xonxoff=True)
