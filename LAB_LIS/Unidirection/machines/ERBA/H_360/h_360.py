...
# logging.basicConfig(filename='port_status_for_h_360.log', level=logging.INFO, format='%(asctime)s - %(message)s')
log_file = 'C:\\ASTM\\root\\log_file\\port_status_for_h560.log'
error_log_file = 'C:\\ASTM\\root\\log_file\\port_status_for_h560_error.log'
...
def save_data_to_file(data):
  try:
    ...
    file_path = os.path.join(output_folder, f'h_360_{timestamp}.txt')
