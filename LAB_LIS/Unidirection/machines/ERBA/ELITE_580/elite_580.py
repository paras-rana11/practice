...
log_file = 'C:\\ASTM\\root\\log_file\\logging_for_elite_580.log'
error_log_file = 'C:\\ASTM\\root\\log_file\\logging_for_elite_580_error.log'
...
def process_data(data):
    try:
        ...
        logger.error(f"Exception during process data :- {e}")
        body_for_db = f' ********************** Exception during process data ********************** \n {e}'
        send_email(subject, body_for_db, to_email, from_email, password)
...
def save_data_to_file(data):
    try:
        ...
        file_path = os.path.join(output_folder, f'elite_580_{timestamp}.txt')
        ...
        logger.error(f"Exception during save data in txt :- {e}")
        body_for_db = f' ********************** Exception during save data in txt ********************** \n {e}'
        send_email(subject, body_for_db, to_email, from_email, password)
            ...
            with conn:
                while True:
                    try:
                        ...
                        logger.info(f"Exception during reading bytes :- {e}")
                        body_for_db = f' ********************** Exception during reading bytes ********************** \n {e}'
                        send_email(subject, body_for_db, to_email, from_email, password)
                    
    except Exception as e:
        logger.error(f"Exception during received data from port :- {e}")
        body_for_db = f' ********************** Exception during received data from port ********************** \n {e}'
        send_email(subject, body_for_db, to_email, from_email, password)
...
if __name__ == '__main__':
    try:
        ...
        body_for_db = f' ********************** Exception in main function ********************** \n {e}'
        send_email(subject, body_for_db, to_email, from_email, password)