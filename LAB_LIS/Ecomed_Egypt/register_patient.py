...
MACHINE_1_COM_PORT = 'P5152'
MACHINE_1_HOST_ADDRESS = '192.168.1.186'
MACHINE_1_HOST_PORT = 5001
SAMPLE_TYPE_MAPPING_FOR_MISPA_MACHINE = {
    "serum": "S1",
    "plasma":  "S1",
    "urine": "S2",
    "sodium flouride": "S3",
...
def process_case(case: Dict[str, Any], case_id: str, responses: List[Dict[str, Any]]):
    try:
        ...
        if machine_id == MACHINE_1_ID:
            ...
            for key, value in SAMPLE_TYPE_MAPPING_FOR_MISPA_MACHINE.items():
